...
import { Youtube, Check, Loader2, ExternalLink, AlertCircle, History } from 'lucide-react';
                    ...
                    <div className="space-y-1.5">
                        {history.map((entry, i) => (
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="flex items-center justify-between px-3 py-2 rounded-lg bg-slate-800/50 hover:bg-slate-800 border border-slate-700/50 hover:border-[#FF0000]/30 transition-all group"
                            >
                                ...
                                <ExternalLink size={11} className="text-slate-600 group-hover:text-[#FF0000] transition-colors shrink-0" />
                            </a>
                        ))}
                    </div>
                </div>
