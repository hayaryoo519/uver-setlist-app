...
const LiveList = () => {
    ...
    const filteredLives = useMemo(() => {
        return lives.filter(live => {
            ...
            const currentVenueName = typeof live.venue === 'object' ? live.venue?.name : live.venue;
            if (filters.venue && currentVenueName !== filters.venue) {
                return false;
            }
                    ...
                    <div className="live-main-inner">
                        ...
                        {!selectedYear ? (
                            ...
                            <div className="filtered-list-container">
                                <h2 className="fade-in">{selectedYear} ({filteredLives.length})</h2>
                                <div className="space-y-4">
